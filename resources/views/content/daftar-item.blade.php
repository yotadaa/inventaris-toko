...
@section('misc')
    ...
    <style>
        ...
        .dropdown-kategori button {
            text-align: left;
            margin-bottom: 4px;
            box-shadow: 0px 0px 4px rgba(66, 57, 57, 0.2);
        }
    </style>
@endsection
@section('body')
                ...
                <div class="card-body">
                    ...
                    <div style='display: flex; gap: 10px'>
                        ...
                        <div class="dropdown">
                            ...
                            <button class=" btn btn-outline-primary d-flex align-items-center" data-bs-toggle="dropdown">
                                <span class="d-none d-md-block dropdown-toggle">
                                    Kategori <i class="bi bi-carret-down-fill"></i>
                                </span>
